...
export function GridSection({ section, isMobile = false }: GridSectionProps) {
  ...
  const getGridColumns = () => {
    if (isMobile) {
      return section.responsive_columns?.mobile || 2;
    }
    return section.responsive_columns?.desktop || section.max_columns || 4;
  };
